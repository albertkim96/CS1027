...
public class Hexagon extends HexComponent
{
	...
	private static final Color PUSHED_COLOR = Color.BLUE;
	private static final Color END_PROCESSED_COLOR = Color.ORANGE;
	private static final Color START_PROCESSED_COLOR = Color.PINK;
	private static final Color POPPED_COLOR = Color.LIGHT_GRAY;

	//enum to represent available hexagon types
	public static enum HexType{WALL, START, END, UNVISITED, PUSHED, END_PROCESSED, START_PROCESSED, POPPED};
 ...
 */
	...
	/**
	 * This method checks if the current hexagon is currently on the stack.
	 * @return true if this is on the stack, false otherwise.
	 */
	public boolean isPushed()
	{
		return type == HexType.PUSHED || type == HexType.START_PROCESSED;
	}
	
	/**
	 * This method checks if the current hexagon was popped from the stack.
	 * This would mean that this hexagon can't be in the path to the end
	 * @return true if this was on the stack but is now popped, false otherwise.
	 */
	public boolean isPopped()
	{
		return type == HexType.POPPED;
	}
	/**
	...
	/**
	 * This method sets the tile to be a popped tile
	 * and updates the tile's colour
	 */
	public void setPopped(){
		this.type = HexType.POPPED;
		this.setColor(this.type);
	}
	...
	private void setColor(HexType t){
		...
		case START_PROCESSED:
			...
			break;
		case POPPED:
			this.setBackground(POPPED_COLOR);
			break;
		default:
			this.setBackground(WALL_COLOR);
			break;
